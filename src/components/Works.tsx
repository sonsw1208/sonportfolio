...
export function Works() {
  ...
  // Lưới card mang key={filter}. BẮT BUỘC: RevealStagger dùng whileInView + viewport once, nên
  // sau khi cụm đã hiện xong nó không phát variant "show" cho RevealItem mount thêm về sau —
  // card của filter mới sẽ kẹt ở opacity 0, nhìn như mất hết video. Đổi key làm cả cụm remount
  // và chạy lại animation stagger cho đúng danh sách mới.
