      ...
      <div className="w-full max-w-container mx-auto px-6">
        ...
        >
          ...
          <div className="relative">
            <span className="eyebrow text-g300">{contact.eyebrow}</span>
            ...
            <a
              ...
              className="inline-flex items-center gap-2.5 rounded-full px-6 py-3.5 font-display font-semibold text-[0.95rem] bg-white text-g700 transition-transform hover:-translate-y-[3px]"
              onClick={() => playClick()}
            >
              <Mail size={18} />
              {contact.email}
